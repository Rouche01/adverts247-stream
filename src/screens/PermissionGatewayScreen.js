        ...
        >
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.infoBox}>
                        <Text style={styles.infoText}>
                            For a smooth and efficient app experience, Adverts247 need the below permissions to access and collect information. You can suspend your permission from your device at any time.
                        </Text>
                    </View>
                    <View style={styles.permissionGroup}>
                        ...
                        <View style={styles.groupInfo}>
                            ...
                            <Text style={styles.groupBody}>
                                We may collect current location data to verify your location and provide current weather data periodically.
                            </Text>
                        </View>
                    ...
                    <View style={styles.permissionGroup}>
                        ...
                        <View style={styles.groupInfo}>
                            ...
                            <Text style={styles.groupBody}>
                                We may require access to your system settings to be able to access and modify your system brightness.
                            </Text>
                        </View>
            ...
            <View style={styles.footer}>
                <Button 
                    ...
                    buttonStyle={{ padding: 10, backgroundColor: '#F1040E', borderRadius: 50 }}
